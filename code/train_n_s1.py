...
class dataset_anti(Dataset):
    ...
    def __getitem__(self, index):
        temp_str = self.data_seq[index]
        temp_data_seqs = ast.literal_eval(temp_str)
...
def main_train():
    ...
    data_dir = r'.\user_data\data\train_data_full_N.csv'
    ...
    for epoch in range(max_epoch):
        ...
        torch.save(model.state_dict(), './weights/model_neu_temp.pth')
        ...
        if temp_com >= max_f1 and epoch+1>30:
            ...
            torch.save(model.state_dict(), './weights/model_neu_best.pth')
