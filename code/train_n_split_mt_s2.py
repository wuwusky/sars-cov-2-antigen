...
def main_train():
    ...
    data_str_dir = './user_data/data_s2/data_str/'
    ...
    for epoch in range(max_epoch):
        ...
        model.eval()
        torch.save(model.state_dict(),  model_save_dir + '/model_neu_mt_str_temp.pth')

        model_eval.load_state_dict(torch.load(model_save_dir + '/model_neu_mt_str_temp.pth', map_location='cpu'), strict=True)
        model_eval.eval()
        ...
        if temp_com >= max_f1 and epoch+1>20:
            ...
            torch.save(model_eval.state_dict(), model_save_dir + 'model_neu_mt_str_best.pth')
